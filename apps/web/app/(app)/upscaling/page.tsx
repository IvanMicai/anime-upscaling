...
// Merge is not here: it has its own page (/merge), and its settings share
// nothing with these.
...
export default function NewUpscalingJobPage() {
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h2 className="mt-2 text-xl font-bold">New Upscaling Job</h2>
        </div>
